# Contributing to materialize-engram

Thank you for considering a contribution—your help keeps this repository healthy for every bobrapet Story.

This guide explains how we work in the `materialize-engram` repository, from filing issues to sending patches.

## How Can I Contribute?

### Reporting Bugs

- Search for an existing report under [Issues](https://github.com/bubustack/materialize-engram/issues).
- If nothing matches, [open a new issue](https://github.com/bubustack/materialize-engram/issues/new) with a clear description, reproduction steps, and both observed and expected behaviour.
...
- Run the quality gates locally:
  - `make lint`
  - `make test`
  - `make docker-build IMG=ghcr.io/<your-user>/materialize-engram:dev` when binaries or Dockerfile paths change
...
2.  Clone your fork: `git clone https://github.com/<your-user>/materialize-engram.git`
3.  Enter the repo: `cd materialize-engram`
